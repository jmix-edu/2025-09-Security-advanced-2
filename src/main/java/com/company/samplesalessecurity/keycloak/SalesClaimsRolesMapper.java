...
public class SalesClaimsRolesMapper extends BaseClaimsRolesMapper {
    ...
    public SalesClaimsRolesMapper(ResourceRoleRepository resourceRoleRepository, RowLevelRoleRepository rowLevelRoleRepository, RoleGrantedAuthorityUtils roleGrantedAuthorityUtils) {
